...
const PermissionSchema = new Schema({
    ...
    content_type: {
        ...
        ref: 'ContentType',
        required: true
        // A reference to the database table, which contains a record for each installed model.
    },
    groups: [{
        type: Schema.Types.ObjectId,
        ref: 'Group',
...
module.exports = mongoose.model('Permission', PermissionSchema, 'xmen_permissions');